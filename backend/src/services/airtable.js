...
//
// ✅ IMPORTANT : NE DOIT JAMAIS throw
// -> si introuvable : retourne { ppu: null, unit: baseU, reason: 'PPU_NOT_FOUND' }
//
...
// ✅ Au lieu de throw : on renvoie un résultat "missing"
dlog('[PPU] missing:', fields[COL_NAME] || fields.NOM, { baseU });
...
const { ppu, unit, reason } = computePPUFromRow(fields);
const ppuRounded = roundPPU(ppu, unit);
...
// pickCheapest attend pricePerUnit => si tous null, on prendra le 1er
const best = pickCheapest(candidates, preferUnitRaw) || candidates[0];
