...
// 1) trier par prix unitaire croissant (null/NaN à la fin)
...
// 2) si égalité : on préfère une unité compatible avec l’unité recette
...
// ───────────────────────────────────────────────────────────
// 1) Essai exact sur Ingrédients (évite les soucis d’accents)
// ───────────────────────────────────────────────────────────
