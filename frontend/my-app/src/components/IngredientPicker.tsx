...
if (!res.ok) throw new Error(json?.error || 'Erreur API suggest')
...
{loading && <div style={{ fontSize: 12, opacity: 0.7, marginTop: 6 }}>Chargement…</div>}
...
<div style={{ fontSize: 12, opacity: 0.7, marginTop: 6 }}>Aucun résultat</div>
)}
</div>
)
}