...
function RecipesInner() {
  ...
  const filterLabel = useMemo(() => (cat ? cat : null), [cat])
                ...
                return (
                  <li key={r.id} className="recipes-card">
                    <Link href={`/recipes/${r.id}`} className="recipes-card-link">
                      {r.imageUrl ? (
                        <img src={r.imageUrl} alt={r.title} className="recipes-card-image" />
                      ) : (
                      ...
                      <div className="recipes-card-body">
                        ...
                        <div className="recipes-card-costs">
                          ...
                          <div>
                            Coût courses : <Price value={r.totalCoursesEur ?? null} blur={limits?.blurPrices} />
                          </div>
                        </div>
